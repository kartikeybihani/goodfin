            ...
            <div className="mt-3 flex items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <div className="mt-1 flex flex-wrap items-center gap-2 text-[12px] text-white/55">
                  ...
                  <span>
                    {formatCompactNumber(company.watchersThisWeek)} investors
                    watched this week
                  </span>
                </div>
              </div>
                ...
                <CardContent>
                  ...
                  >
                    ...
                    <div className="mt-1 text-[11px] text-white/55">
                      Tight terms + information rights matter more than entry
                      price on longer lockups.
                    </div>
                  </motion.div>
                </CardContent>
              </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="text-[11px] text-white/50">
                  Interprets the secondary tape: inquiries, clears, dispersion,
                  and time-to-fill.
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="rounded-2xl border border-white/10 bg-black/[0.18] p-3">
                  ...
                  <div className="mt-2 text-[11px] text-white/55">
                    Suggested: split into 2–3 tranches to reduce price
                    dispersion.
                  </div>
                  <div className="mt-3">
